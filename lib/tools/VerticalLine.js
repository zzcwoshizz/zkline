...
var VerticalLine = function (_BaseTool) {
    _inherits(VerticalLine, _BaseTool);

    function VerticalLine(ctx, colors, context, max_step) {
        _classCallCheck(this, VerticalLine);

        var _this = _possibleConstructorReturn(this, (VerticalLine.__proto__ || Object.getPrototypeOf(VerticalLine)).call(this, ctx, colors, context));
