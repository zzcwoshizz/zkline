       ...
       */
                ...
                function parse(input) {
                    var options = arguments.length > 1 ? arguments[1] : {},
                        ...
                        peg$c6 = function(ch, args) {
                            ...
                            ops.push({
                                type: 'moveTo',
                                args: makeAbsolute(moveCh, args[0])
                            });
                        ...
                        peg$c16 = function(ch, args) {
                            for (var i = 0; i < args.length; i++) {
                                ops.push({
                                    type: 'lineTo',
                                    args: makeAbsoluteFromX(ch, args[i])
                                });
                            }
                        },
                        peg$c17 = /^[Vv]/,
                        ...
                        peg$c19 = function(ch, args) {
                            for (var i = 0; i < args.length; i++) {
                                ops.push({
                                    type: 'lineTo',
                                    args: makeAbsoluteFromY(ch, args[i])
                                });
                            }
                        },
                        peg$c20 = /^[Cc]/,
                        ...
                        peg$c22 = function(ch, args) {
                            for (var i = 0; i < args.length; i++) {
                                ops.push({
                                    type: 'bezierCurveTo',
                                    args: makeAbsoluteMultiple(ch, args[i])
                                });
                            }
                        },
                        ...
                        peg$c26 = function(ch, args) {
                            for (var i = 0; i < args.length; i++) {
                                ops.push({
                                    type: 'bezierCurveTo',
                                    args: makeReflected().concat(
                                        makeAbsoluteMultiple(ch, args[i])
                                    )
                                });
                            }
                        },
                    ...
                    function peg$buildException(message, expected, pos) {
                        ...
                        var posDetails = peg$computePosDetails(pos),
                            found =
                                pos < input.length ? input.charAt(pos) : null;
                    ...
                    function ellipseFromEllipticalArc(
                        ...
                        var lambda = Math.sqrt(
                            xPrime2[0] / rx2 + xPrime2[1] / ry2
                        );
                        if (lambda > 1) {
                            rx *= lambda;
                            ry *= lambda;
                        ...
                        var factor = Math.sqrt(
                            Math.abs(
                                rx2 * ry2 - rx2 * xPrime2[1] - ry2 * xPrime2[0]
                            ) /
                        ...
                        var cPrime = scale(factor, [
                            (rx * xPrime[1]) / ry,
                            (-ry * xPrime[0]) / rx
                        ]); // F.6.5.2
                        var c = sum(
                            rotCounterClockwise(cPrime, phi),
                            meanVec(x1, x2)
                        ); // F.6.5.3
                        var x1UnitVector = [
            ...
            function Path_(arg) {
                ...
                if (typeof arg == 'string') {
                    ...
                    throw 'Error: ' +
                        typeof arg +
                        'is not a valid argument to Path';
                }
            }
            ...
            Path_.prototype['addPath'] = function(path, tr) {
                ...
                if (
                    ...
                    this.ops_.push({
                        type: 'transform',
                        args: [tr.a, tr.b, tr.c, tr.d, tr.e, tr.f]
                    });
                }
            ...
            CanvasRenderingContext2D.prototype.fill = function(arg) {
                if (arg instanceof Path_) {
                    ...
                    for (var i = 0, len = arg.ops_.length; i < len; i++) {
                        var op = arg.ops_[i];
                        CanvasRenderingContext2D.prototype[op.type].apply(
                            this,
                            op.args
                        );
                    }
            ...
            CanvasRenderingContext2D.prototype.isPointInStroke = function(arg) {
                if (arg instanceof Path_) {
                    ...
                    return original_is_point_in_stroke.apply(
                        this,
                        Array.prototype.slice.call(arguments, 1)
                    );
                } else {
